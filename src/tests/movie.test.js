...
//*CREATE MOVIE
test('POST / movie debe de crear un movie', async() => {
...
test('POST / movies/:id/genres debe insertar generos a un artista', async() => {
...
test('POST / movies/:id/actors debe insertar generos a un artista', async() => {
...
test('POST / movies/:id/directors debe insertar generos a un artista', async() => {
